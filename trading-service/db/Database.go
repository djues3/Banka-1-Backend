...
func InitTestDatabase() error {
	...
	return DB.AutoMigrate(&types.Security{}, &types.Order{}, &types.Actuary{}, &types.Transaction{}, &types.Portfolio{}, &types.OTCTrade{}, &types.OptionContract{}, &types.Listing{}, &types.OTCSagaState{})
}
